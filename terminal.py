...
if var[0] == "1":
    ...
    output = subprocess.getoutput("sudo " + cmd + " --kubeconfig /root/TASK_9/admin.conf")
    print(output)
elif var[0] == "2":
    pod_name = var[2]
    image_name = var[1]
    ...
    cmd = "sudo kubectl get pods --kubeconfig /root/TASK_9/admin.conf"
    output = subprocess.getoutput(cmd)
    print(output)
elif var[0] == "8":
    cmd = "kubectl get deployments --kubeconfig /root/TASK_9/admin.conf"
    output = subprocess.getoutput("sudo " + cmd)
    print(output)
elif var[0] == "9":
    cmd = "kubectl get svc --kubeconfig /root/TASK_9/admin.conf"
    output = subprocess.getoutput(cmd)
    print(output)
elif var[0] == "10":
    cmd = "kubectl delete all --all --kubeconfig /root/TASK_9/admin.conf"
    output = subprocess.getoutput("sudo " + cmd)
    print(output)
elif var[0] == "11":
